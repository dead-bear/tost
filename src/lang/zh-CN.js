const lang = {
  ...
  cashoutBank: {
    ...
    wenxingtishiText: '温馨提醒',
    tishiOneText: '1、新用户需要完成12次量化才能提现。',
    tishiTwoText: '2、提现金额不低于30USDT,手续费为3%。',
  ...
  lianghua: {
    ...
    xuyaoYaoQingText: '需要邀请{val1}名下属,每名下属累计充值{val2}U',
    zhuyiText: '注意',
    dengjiTitleText: 'VIP等级',
    shenjitiaoJianText: '升级条件',
    tuiguangHuiYuanText: '推广会员',
    quanyiText: '{val1}权益',
  ...
  mycenter: {
    ...
    yuyanSetText: '语言设置',
    aboutUsText: '关于我们',
    gongsijianjieText: '公司简介',
    pingtaiguizeText: '平台规则',
    xiazaiAppText: '下载APP',
  ...
  myTeamNew: {
    titleText: '我的团队',
    tuanduiShuJuGaiLanText: '团队数据概览',
    zhuceHuiYuanText: '注册会员',
    youxiaoHuiYuanText: '有效会员',
    tuanduiShouRuText: '团队收入',
    leijiTuanDuiGuiMiText: '累积团队规模',
    chakanTuanDuiLieBiaoText: '查看团队列表',
    zuijingSanDaiShuJuText: '最近三代数据',
    yidaiShuJuText: '一代数据',
    tuanduiYongJinText: '团队佣金',
    erdaiShuJuText: '二代数据',
    sandaiShuJuText: '三代数据',
    allText: '全部',
    oneDayText: '今日',
    threeDayText: '近3日',
    sevenDayText: '近7日',
  ...
  rechargeTips: {
    titleText: '注意',
    rechgarge1TipsText: '1. 充值地址为USDT-TRC20，充值前请仔细检查。',
    rechgarge2TipsText: '2.最低充值额为30USDT，低于30USDT的金额将不予入账。',
    rechgarge3TipsText: '3. 充值成功后，会在3-5分钟内自动到达账户。',
    rechgarge4TipsText: '4、每次充值都需要获取最新的充值地址，请勿多次保存充值地址',
  },
  rechargebank: {
    titleText: '银行卡入款',
    tipsText: '购买数量',
  ...
  wakuang: {
    ...
    seemoreText: '查看更多',
    changjianwentiText: '常见问题',
    popItem1TitleText: '什么是Snavo 云矿机？',
    popItem1ContentText: 'Snavo 云矿机是本公司打造的一款帮助用户快捷进行链上质押获取奖励的工具产品。通过将数字资产质押在区块链网络，并获得基于POS（Proof of Stake，即权益证明）机制产生的奖励。在这个机制中，用户将数字资产委托给节点，节点在区块链上行使出块、打包交易等权利并获得奖励。用户根据锁仓数量按比例分享节点获得的奖励。',
    popItem2TitleText: '产品优势',
    popItem2SubTitleText: '稳健型',
    popItem2ContentText: 'Snavo 云矿机可以获得第三方相对稳定的奖励，产品期限多样。',
    popItem3TitleText: '投向生息资产说明',
    popItem3ContentText: 'Snavo 云矿机是将您的数字资产质押在区块链上，以支持该区块链网络的运营，并获得相应的奖励。',
