<template>
<div class="s_main_bottom_swiper">
  <div class="s-main-swiper-box">
    <div class="swiper-wrapper">
      <div class="swiper-slide g-flex-align-center" v-for="(item, index) in props.list" :key="index">
        <div class="s-swiper-silde-item-content g-flex-align-center">
          ...
          <div class="s-swiper-silde-item-status g-flex-justify-center">
            <span>{{ i18n.lianghuaChengGongText }}</span>
          </div>
        </div>
      </div>
    </div>
...
function onShow() {
  ...
  nextTick(() => {
    ...
    swiperInstance.value = new Swiper('.s-main-swiper-box', {
      loop: true,
      direction: 'vertical',
      slidesPerView: 10,
      spaceBetween: 0,
