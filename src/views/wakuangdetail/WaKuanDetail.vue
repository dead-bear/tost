<template>
  <div class="v_wa_kuang_detail g-flex-column">
    ...
    <div class="v-wakuang-detail-container g-flex-column">
      ...
      <div class="v-wakuang-detail-content">
        ...
        <div class="v-content-item g-flex-justify-between g-flex-align-center">
          <div class="v-content-item-desc g-flex-column">
            <p class="v-content-item-desc-title">
              {{ i18n.yujishouyiText }}(USDT)
            </p>
            <p class="v-content-item-desc-val g-main-color g-fsize16">
              {{ yujiShouyi }}
            </p>
          </div>
          <div class="v-content-item-desc g-flex-column g-flex-align-end">
            <p class="v-content-item-desc-title">
              {{ i18n.canuseMoneyText }}(USDT)
            </p>
            <p class="v-content-item-desc-val">
              {{ userInfo.balance }}
            </p>
