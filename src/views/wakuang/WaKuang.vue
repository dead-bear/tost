<template>
  <div class="v_wa_kuang_list g-flex-column">
    ...
    <div class="v-wakuang-list-container g-flex-column">
        ...
        <div class="v-wakuang-finance-bottom g-flex-align-center">
          <div class="v-wakuang-finance-bottom-item g-flex-column g-flex-align-center">
            ...
            <div class="v-wakuang-finance-bottom-item-val">
              {{ totalInfo.obj.todayProfitAmount }}
            </div>
          </div>
          <div class="v-wakuang-finance-bottom-item g-flex-column g-flex-align-center">
            <div class="v-wakuang-finance-bottom-item-title">
            ...
            <div class="v-wakuang-finance-bottom-item-val">
              {{ totalInfo.obj.totalProfitAmount }}
            </div>
          </div>
          <div class="v-wakuang-finance-bottom-item g-flex-column g-flex-align-center">
            <div class="v-wakuang-finance-bottom-item-title">
            ...
            <div class="v-wakuang-finance-bottom-item-val">
              {{ totalInfo.obj.orderNums }}
            </div>
          </div>
        </div>

        <div class="v-wakuang-finance-order-detail g-flex-align-center g-flex-justify-center">
          <div @click="$router.push({ name: 'wakuangorderlist' })" class="v-wakuang-finance-order-detail-btn">
