<template>
  <div class="v_wakuang_order_list g-flex-column">
        ...
        <div class="v-item" v-for="(item, index) in list.list" :key="index">
          ...
          <div class="v-item-bottom-list g-flex-align-center">
            <div class="v-bottom-list-item g-flex-column">
              ...
              <span class="v-bottom-list-item-val">{{ item.amount }}USDT</span>
            </div>
            <div class="v-bottom-list-item g-flex-column">
          ...
          <div class="v-item-bottom-list g-flex-align-center">
            ...
            <div v-if="item.status != 4" class="v-bottom-list-item g-flex-column g-flex-align-end">
              ...
              <span class="v-bottom-list-item-val">{{ item.profit_amount }} USDT</span>
            </div>
            <div v-if="item.status == 4" class="v-bottom-list-item g-flex-column g-flex-align-end">
              <p class="v-bottom-list-item-title">{{ i18n.shouyiText }}</p>
              <span class="v-bottom-list-item-val">{{ '0.00' }} USDT</span>
            </div>
          </div>
          <div v-show="item.status == 0" class="v-item-bottom-list g-flex-align-center">
