<template>
  <div class="v_msg_center g-flex-column">
    ...
    <div class="v-msg-container g-flex-column">
      <div class="v-msg-nav-box">
        <!-- line-height="2px" color="#644FDC" title-inactive-color="#000" title-active-color="#644FDC"
        ...
        <van-tabs @change="headNavItemClick" color="#644FDC" title-inactive-color="#000" title-active-color="#644FDC"
          background="var(--g-main-bgColor)" class="v-msg-nav-list" v-model:active="form.type">
