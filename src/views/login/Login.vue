  ...
  <div class="v_login g-flex-column">
    <div class="v-login-head g-flex-align-center">
      ...
      <div class="v-login-head-language g-flex-align-center">
        ...
        <div @click="$router.push({ name: 'languageset' })" class="v-login-head-language-img g-flex-align-center g-flex-justify-center">
    ...
    <div class="v-login-container">
      ...
      <div class="v-nav-list g-flex-align-center">
        <div @click="typeClick(1)" :class="form.type == 2 ? 'active' : ''" class="v-nav-item">
          <span>{{ i18n.emailLoginText }}</span>
        </div>
...
let form = reactive({
  type: 2, //0 用户名邮箱  1 手机登录 2 手机验证码登录  3邮箱验证码登录
  area_code: '',
  mobile: '',
  // email: '',
  account: '',
